...
data class Player(
    ...
    companion object {
        fun sortingOptions() = listOf(
            ...
            Sorting.TeamAscending,
            Sorting.TeamDescending,
            Sorting.PointsAscending,
            Sorting.PointsDescending,
            Sorting.PendingAscending,
            Sorting.PendingDescending,
            Sorting.PlayedAscending,
            Sorting.PlayedDescending,
            Sorting.ByeAscending,
            Sorting.ByeDescending
        )
    }
}
...
fun List<Player>.sort(sortedBy: Player.Sorting): List<Player> =
    when (sortedBy) {
        ...
        Player.Sorting.PointsAscending -> sortedWith(compareBy(
            Player::wonGames, Player::lostGames, Player::wonSets, Player::lostSets, Player::wonPoints, Player::lostPoints))
        Player.Sorting.PointsDescending -> sortedWith(compareBy(
            Player::wonGames, Player::lostGames, Player::wonSets, Player::lostSets, Player::wonPoints, Player::lostPoints).reversed())
